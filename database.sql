...
VALUES
	('08:15:23', '2024-01-01', 12, 3, 5),
	('09:45:10', '2024-01-02', 7, 2, 8),
	('10:30:45', '2024-01-03', 18, 4, 6),
	('11:15:30', '2024-01-04', 23, 5, 1),
	('12:00:00', '2024-01-05', 1, 1, 7),
	('13:45:22', '2024-01-06', 15, 6, 4),
	('14:30:10', '2024-01-07', 9, 3, 2),
	('15:20:35', '2024-01-08', 6, 2, 5),
	('16:10:15', '2024-01-09', 21, 4, 8),
	('17:05:40', '2024-01-10', 4, 1, 3),
	('18:25:55', '2024-01-11', 17, 5, 7),
	('19:15:05', '2024-01-12', 2, 3, 6),
	('20:10:50', '2024-01-13', 13, 2, 4),
	('20:25:30', '2024-01-14', 8, 6, 1),
	('20:35:33', '2024-01-15', 11, 4, 2),
	('20:45:10', '2024-01-16', 24, 5, 3),
	('20:55:20', '2024-01-17', 5, 1, 7),
	('01:30:55', '2024-01-18', 20, 2, 8),
	('02:15:30', '2024-01-19', 3, 4, 5),
	('03:10:45', '2024-01-20', 22, 3, 6),
	('04:55:50', '2024-01-21', 16, 6, 2),
	('05:40:15', '2024-01-22', 7, 1, 4),
	('06:25:30', '2024-01-23', 14, 5, 3),
	('07:10:10', '2024-01-24', 19, 2, 8),
	('08:55:25', '2024-01-25', 10, 4, 1);
...
-- 2.j
SELECT cl.nome, cp.valor_desconto
FROM compras_produtos AS cp INNER JOIN compras AS co
 ON cp.cod_compra = co.cod_compra
INNER JOIN clientes AS cl
 ON co.cod_cliente = cl.cod_cliente
